    ...
    <Base>
        <div class="pt-8">
            <div class="grid md:grid-cols-2 bg-fdtm rounded-xl m-8 lg:mx-16">
                <div
                    class="!bg-no-repeat !bg-center !bg-cover rounded-t-xl md:rounded-l-xl md:rounded-tr-none min-h-[25vh]"
                    style="background: url('ebus.jpg')"
                >
                    <div
                        class="bg-fdtm/30 h-full w-full rounded-t-xl md:rounded-l-xl md:rounded-tr-none"
                    />
                </div>
                ...
                <div class="text-white text-lg px-8 py-12 flex items-center">
                    <div>
                        ...
                        <p class="text-sm mb-4">
                            Yuk eksplorasi Kota Malang dengan mudah dan nyaman melalui transportasi
                            umum yang tersedia.
                        </p>
            ...
            <section id="intro" class="p-8 lg:p-16">
                <div>
                    ...
                    <div class="md:grid md:grid-cols-2 w-full mt-6">
                        <div class="prose">
                            <p>
                                Forum Diskusi Transportasi Malang (FDTM) merupakan forum diskusi
                                yang membahas berbagai topik terkait transportasi di Kota Malang.
                                FDTM merupakan forum yang terbuka bagi siapa saja yang ingin
                                berdiskusi dan berbagi informasi terkait transportasi di Kota
                                Malang.
                            </p>
                ...
                <div id="news" class="my-12">
                    ...
                    <template v-if="informations.length">
                        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-12 mt-6">
                            <a
                                v-for="(information, i) in paginatedInformations"
                                :key="i"
                                :href="information.url"
                            >
                                <div
                                    class="bg-slate-50 rounded-lg shadow-md hover:shadow-fdtm hover:bg-slate-100/80"
                                >
                                    <div
                                        class="h-32 bg-center bg-no-repeat bg-cover rounded-t-lg shadow-lg"
                                        :style="`background-image: url(${information.image})`"
                                    />

                                    <div class="p-6">
                                        <h3
                                            class="font-semibold text-fdtm text-lg"
                                            v-text="information.title"
                                        />
                        ...
                        <div class="flex justify-center gap-x-4 mt-8">
                            <button
                                ...
                                :disabled="page === 1"
                                class="p-2 px-4 bg-fdtm text-white rounded-md hover:bg-fdtm/70 hover:text-slate-50 disabled:bg-fdtm/25"
                            >
                            ...
                            <button
                                @click="setPage(page + 1)"
                                :disabled="page === Math.ceil(informations.length / perPage)"
                                class="p-2 px-4 bg-fdtm text-white rounded-md hover:bg-fdtm/70 hover:text-slate-50 disabled:bg-fdtm/25"
                            >
