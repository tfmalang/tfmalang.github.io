...
const defaultTags = () => {
    ...
    tags.push(generateTags('author', 'FDTM-TfM'))
...
chibiconTags.push(generateTags('description', 'TfM support for TfSurabaya ChiBiCon 2024.'))

linkTags.push(
    generateTags('description', 'Link cepat untuk mengakses informasi penting di FDTM - TfM.')
)
